...
class Config():
	...
	def __init__(self, sub_name):
		...
		self.reddit_object = praw.Reddit(client_id=self.client_id, client_secret=self.client_secret, user_agent='Swap Bot for ' + self.subreddit_name + ' v1.0 (by u/RegExr and u/BourbonInExile)', refresh_token=self.refresh_token)
